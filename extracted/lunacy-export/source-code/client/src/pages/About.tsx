    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-5xl px-4 sm:px-8 py-24 border-b border-border">
        <div className="grid md:grid-cols-2 gap-16">
          <div>
            ...
            <h3 className="text-xl font-medium mb-6">Kailash</h3>
            <p className="text-muted mb-6 font-light leading-relaxed">
              Lunacy Media is a love letter to the inner child in all of us.
            </p>
            <p className="text-muted mb-6 font-light leading-relaxed">
            ...
            <p className="text-muted mb-6 font-light leading-relaxed">
              Where others saw fantasy, I saw meaning. Where others saw imagination, I saw possibility.
            </p>
            <p className="text-muted mb-6 font-light leading-relaxed">
            ...
            <p className="text-muted mb-6 font-light leading-relaxed">
              They were searching for meaning. That is where Lunacy Media lives.
            </p>
            <p className="text-muted mb-6 font-light leading-relaxed">
      ...
      <footer className="border-t border-border bg-secondary/30">
        <div className="mx-auto max-w-5xl px-4 sm:px-8 py-12 flex justify-between items-center flex-wrap gap-4 text-xs text-muted font-light">
          <span>© {new Date().getFullYear()} Lunacy Media Inc.</span>
          <span>The light of the moon is simply a reflection of the brightest star.</span>
        </div>
      </footer>
    </div>
  );
