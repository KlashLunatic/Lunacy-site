...
const ORBITAL_SECTIONS = [
  {
    title: 'The moon teaches us',
    subtitle: "that sometimes…it's not just a phase.",
    description: 'Lunacy Media is a mythology and worldbuilding studio for artists, founders, and organizations who were never meant to be ordinary.',
    link: '/about',
    tags: ['Mythology', 'Worldbuilding', 'Universe'],
    stat: '∞',
    statLabel: 'Creative Vision',
  },
  {
    title: 'We work with the ones',
    subtitle: 'who already know.',
    description: 'Artists who sense their work is bigger than its current container. Founders who feel their brand is missing its soul. Organizations ready to stop communicating and start meaning something.',
    link: '/contact',
    tags: ['Artists', 'Founders', 'Organizations'],
    stat: '1',
    statLabel: 'Universe',
  },
  {
    title: 'This is not a portfolio.',
    subtitle: 'This is a universe.',
    description: 'Lunacy Media creates across music, manga, interactive experience, and divination — connected by a single mythological thread: The Sisters Grim.',
    link: '/portfolio',
    tags: ['Music', 'Manga', 'AR/VR', 'Divination'],
    stat: '4',
    statLabel: 'Projects',
  },
  {
    title: 'The Trisomy',
    subtitle: 'Music — Trilogy',
    description: 'A three-part musical odyssey exploring identity, memory, and legacy. Mulligan. Between the Last Letters. Kalu Ram. A mythic autobiography told through hip-hop, poetry, and worldbuilding.',
    link: '/releases',
    tags: ['Music', 'Evolution', 'Hip-Hop'],
    stat: '3',
    statLabel: 'Albums',
  },
  {
    title: 'Obeah',
    subtitle: 'Manga',
    description: 'Magic was never the mystery. History was.',
    link: '/obeah',
    tags: ['Manga', 'Reclamation', 'Mythology'],
    stat: '1',
    statLabel: 'Series',
  },
  {
    ...
    description: "Tammy is not a lesson. She's an encounter.",
    link: '/interactive-worlds',
    tags: ['AR/VR', 'Misinformation', 'Interactive'],
    stat: '1',
  ...
  },
  {
    title: 'The Tarot',
    subtitle: 'Divination',
    description: 'An entire mythology transformed into a divination system.',
    link: '/about',
    tags: ['Divination', 'Mythology', 'System'],
    stat: '78',
    statLabel: 'Cards',
  },
  {
    title: 'Begin with Nebula',
    subtitle: 'Every world begins the same way.',
    description: 'A feeling. A question. A vision that refuses to stay quiet. If something brought you here — trust it. The stars have aligned.',
    link: '/contact',
    tags: ['Collaboration', 'Partnership', 'Creation'],
    stat: '∞',
